...
<article class="w-full max-w-[40rem] bg-white rounded-lg px-2 md:px-10 py-10 dark:bg-gray-800">
	<Breadcrumb>
	...
	<div class="mt-8 overflow-x-scroll md:overflow-x-auto">
	...
	<div class="mt-5">
		<img
			...
			class="w-full md:w-3/4 md:mx-auto h-auto"
			alt={`「${article.title}」のイメージ画像`}
		/>
	</div>
