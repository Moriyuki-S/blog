...
<Dropdown>
    <DropdownItem class="text-xl font-bold flex items-center" on:click={() => handleChangeDisplayTheme('light')}>
        <SunOutline class="inline w-7 h-7 me-2 pt-1" />
        Light
    </DropdownItem>
    <DropdownItem class="text-xl font-bold flex items-center" on:click={() => handleChangeDisplayTheme('dark')}>
